...
- (void)configScrollViewWith:(NSInteger)clickTag andAppendArray:(NSArray *)appendArray{
    ...
    for (int i = 0; i < appendArray.count; i ++) {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[appendArray objectAtIndex:i]]] placeholderImage:[UIImage imageNamed:@"placeholder"]];
