...
-(void)RequestData
{
    ...
    [dataprovider GetShowOrderOrderListWithKey:_key andorder:[NSString stringWithFormat:@"%d",getMineList]];
...
- (void)viewDidLoad {
    ...
    [self addRightButton:@"index_showOrder_right_icon@2x.png"];
    _lblTitle.text=@"晒单圈";
...
-(void)clickRightButton:(UIButton *)sender
{
    ...
    wxVc.key=_key;
    wxVc.nickName=_nickName;
    wxVc.avatarImageHeader=_avatarImageHeader;
...
-(void)BuildHeaderView
{
    ...
    self.segmentedControl = [[HYSegmentedControl alloc] initWithOriginY:150 Titles:@[@"默认", @"本周",@"总评论数",@"点赞数"] delegate:self] ;
